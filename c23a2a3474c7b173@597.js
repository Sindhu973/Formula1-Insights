...
function _6(altplot,metric){return(
altplot(`Plot.plot({
  x: {
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["state-population-2010-2019.tsv", {url: new URL("./files/553ece9b37cf5bc5cd7da5709585f70ecddac30e8df28cf16a0689d4e2ace1c35f6d18033cc2e4920ac7920b2549211e3b9f4b73460bf5c19e01a64051403866.tsv", import.meta.url), mimeType: "text/tab-separated-values", toString}]
  ]);
  ...
  main.variable(observer()).define(["altplot","metric"], _6);
