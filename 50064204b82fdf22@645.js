// https://observablehq.com/@d3/pie-chart@645
import define1 from "./7a9e12f9fb3d8e06@459.js";

function _1(d3,population,md){return(
md`# Pie Chart

This chart shows the estimated population by age in the United States as of 2015. The total estimated population is ${d3.sum(population, d => d.value).toLocaleString("en-US")}. Data: [U.S. Census](https://www.census.gov/data.html).`
)}

function _chart(PieChart,population,width){return(
PieChart(population, {
  name: d => d.name,
  value: d => d.value,
  width,
...
export default function define(runtime, observer) {
  ...
  main.variable(observer()).define(["d3","population","md"], _1);
